...
import futsal2 from "../image/futsal2.png";
import futsal3 from "../image/futsal3.png";
import futsal4 from "../image/futsal4.png";
        ...
        <div className="mx-20 border-2 rounded-lg py-10">
          ...
          <div class=" ml-20 mt-10 flex border-0">
            ...
            <button
              ...
              data-te-ripple-color="light"
            >
              <img class="rounded-t-lg" src={futsal3} alt="" />
            </button>
            <div
              data-te-modal-init
          ...
          <div class=" ml-20 mt-10 flex border-0">
            <button
              className="w-6/12 mx-10"
              data-te-toggle="modal"
              data-te-target="#exampleModal"
              data-te-ripple-init
              data-te-ripple-color="light"
            >
              <img class="rounded-t-lg" src={futsal2} alt="" />
            </button>
            <button
              className="w-6/12 mx-10"
              data-te-toggle="modal"
              ...
              data-te-ripple-color="light"
            >
              <img class="rounded-t-lg" src={futsal4} alt="" />
            </button>
            <div
              data-te-modal-init
              class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
