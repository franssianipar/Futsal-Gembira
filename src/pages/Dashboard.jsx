    ...
    <>
      <div className="bg-[#2F2F2F]">
        <div className="flex ml-32">
          ...
          <div className="flex text-2xl px-10  ml-auto">
      ...
      <div className=" py-5 bg-[#363636] pt-12 ">
        <div className="mx-20 border-2 py-10">
          ...
          <div className=" flex justify-between mt-10 mx-48 ">
            <button className=" z-10 relative hover:rounded-lg  bg-transparent  font-medium uppercase text-white transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-y-0 before:bg-[#2F2F2F] before:transition-transform before:duration-300 before:content-[''] hover:text-white before:hover:scale-y-100 w-6/12  text-left text-lg  rounded-lg px-10 py-10 mt-10 ">
          ...
          <div className="bg-[#2F2F2F] py-10 mx-48   ">
